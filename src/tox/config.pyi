...
class VenvAttribute:
    ...
    postprocess: Optional[PostProcess] = ...
    def __init__(
        self, name: str, type: str, default: Any, help: str, postprocess: Optional[PostProcess]
    ) -> None: ...
...
class DepOption:
    ...
    help: str = ...
    default: Tuple = ...
    def postprocess(self, testenv_config: TestenvConfig, value: Sequence[str]) -> List[DepConfig]: ...
